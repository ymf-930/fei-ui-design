            ...
            <!--            <li title="Share">
                          <button>
                            ...
                            <ul class="options">
                              <li class="tw">
                                <a target="_blank"
                                   :href="`https://twitter.com/intent/tweet?url=https%3A%2F%2Flusaxweb.github.io%2Fvuesax&text=@vuesax+framework+components+for+vuejs+/+${page.title}&hashtags=${page.title},framework,components,vuejs,vuesax,lusaxweb,design,developer,frontend`">
                              ...
                              <li class="in">
                                <a target="_blank"
                                   :href="`https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Flusaxweb.github.io%2Fvuesax&title=FEI-UI-DESIGN+Framework&summary=framework+components+for+vuejs.&source=FEI-UI-DESIGN`">
                              ...
                              <li class="redit">
                                <a target="_blank"
                                   :href="`https://www.reddit.com/submit?url=https%3A%2F%2Flusaxweb.github.io%2Fvuesax&title=FEI-UI-DESIGN+Framework+components+for+vuejs`">
...
onMounted(() => {
  ...
  window.addEventListener('scroll', (e) => {
    ...
    if (title.value && flex.value) {
      title.value.style.fontSize = `${35 - (window.pageYOffset / 7) > 24 ? 35 - (window.pageYOffset / 8) : 20}px`
