...
// node_modules/.pnpm/@firebase+auth@0.15.0_@firebase+app-types@0.6.1_@firebase+app@0.6.11_@firebase+util@0.3.2/node_modules/@firebase/auth/dist/auth.esm.js
...
(function() {
  ...
  function Ob(a) {
    eb.test(a) && (-1 != a.indexOf("&") && (a = a.replace(Za, "&amp;")), -1 != a.indexOf("<") && (a = a.replace($a, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(ab, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(bb, "&quot;")), -1 != a.indexOf("'") && (a = a.replace(cb, "&#39;")), -1 != a.indexOf("\0") && (a = a.replace(db, "&#0;")));
    return a;
  }
  ;
  function Pb(a) {
  ...
  function Tc(a) {
    if (!a.xa && (a.xa = true, a.Da(), 0 != Rc)) {
      var b = oa(a);
      if (0 != Rc && a.oa && 0 < a.oa.length)
  ...
  function nd(a, b, c, d, e, f) {
    ...
    if (!c.proxy) {
      ...
      if (a.addEventListener)
        Xc || (e = g), void 0 === e && (e = false), a.addEventListener(b.toString(), d, e);
  ...
  function G(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      (d = n(d) ? !!d.capture : !!d, c = ld(c), a && a[$c]) ? (a = a.v, b = String(b).toString(), b in a.a && (f = a.a[b], c = ed(f, c, d, e), -1 < c && (cd(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.a[b], a.b--)))) : a && (a = od(a)) && (b = a.a[b.toString()], a = -1, b && (a = ed(b, c, d, e)), (c = -1 < a ? b[a] : null) && td(c));
  }
  function td(a) {
    ...
    if (a = od(a)) {
      if (b = a.a[b.toString()])
        for (b = b.concat(), a = 0; a < b.length; a++) {
          var f = b[a];
          f && f.capture == c && !f.va && (f = vd(f, d), e = e && false !== f);
        }
    }
    return e;
  }
  ...
  function Jd(a, b) {
    ...
    this.i = false;
    var c;
    a instanceof Jd ? (this.i = void 0 !== b ? b : a.i, Kd(this, a.f), this.l = a.l, this.a = a.a, Ld(this, a.g), this.c = a.c, Md(this, Nd(a.b)), this.h = a.h) : a && (c = String(a).match(Hd)) ? (this.i = !!b, Kd(this, c[1] || "", true), this.l = Od(c[2] || ""), this.a = Od(c[3] || "", true), Ld(this, c[4]), this.c = Od(c[5] || "", true), Md(this, c[6] || "", true), this.h = Od(c[7] || "")) : (this.i = !!b, this.b = new Pd(null, this.i));
  }
  Jd.prototype.toString = function() {
    ...
    var c = this.a;
    if (c || "file" == b)
      a.push("//"), (b = this.l) && a.push(Qd(b, Rd, true), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.g, null != c && a.push(":", String(c));
    if (c = this.c)
  ...
  function Fe() {
    return import_app.default.INTERNAL.hasOwnProperty("reactNative") ? "ReactNative" : import_app.default.INTERNAL.hasOwnProperty("node") ? "Node" : Ee() ? "Worker" : "Browser";
  }
  function Ge() {
    var a = Fe();
  ...
  function Se(a) {
    a = a || K();
    return "Safari" == qe(a) || a.toLowerCase().match(/iphone|ipad|ipod/) ? false : true;
  }
  function Te() {
    var a = l.___jsl;
    if (a && a.H) {
  ...
  function Of(a) {
    ...
    if ((b = a[Uf]) && "object" === typeof b)
      if (b = b[Vf], "string" === typeof b && b.length)
        this.f = b;
      else {
        if ("undefined" !== typeof b)
    ...
    for (var d = c = false; a.g.length && !a.i; ) {
      ...
      if (f = a.f ? g : f)
        try {
          ...
          if (Ca(b) || "function" === typeof l.Promise && b instanceof l.Promise)
            d = true, a.i = true;
        } catch (m) {
  ...
  var vi = {};
  function xi(a) {
    var b = {}, c = b.document || document, d = wb(a).toString(), e = jc(document, "SCRIPT"), f = { Vb: e, Ma: void 0 }, g = new li(f), h = null, m = null != b.timeout ? b.timeout : 5e3;
    ...
    e.onload = e.onreadystatechange = function() {
      e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (yi(e, b.wd || false, h), oi(g), pi(g, true, null));
    };
    e.onerror = function() {
      yi(e, true, h);
  ...
  function mi() {
    if (this && this.Vb) {
      var a = this.Vb;
      a && "SCRIPT" == a.tagName && yi(a, true, this.Ma);
    }
  }
  function yi(a, b, c) {
  ...
  Ei.prototype.u = function(a, b, c, d, e, f) {
    if (Ee() && ("undefined" === typeof l.fetch || "undefined" === typeof l.Headers || "undefined" === typeof l.Request))
  ...
  Sj.prototype.toString = function() {
    ...
    if (this.a.isOAuthProvider) {
      var b = this.a;
      try {
        var c = import_app.default.app(this.c).auth().ka();
      } catch (h) {
        c = null;
      }
      b.nb = c;
  ...
  function Tj(a) {
    try {
      return import_app.default.app(a).auth().Ga();
    } catch (b) {
      return [];
    }
  }
    ...
    return Zi(a).then(function(c) {
      a: {
        ...
        for (var f = 0; f < c.length; f++) {
          ...
          var h = d;
          var m = e;
          0 == g.indexOf("chrome-extension://") ? h = J(g).a == h && "chrome-extension" == m : "http" != m && "https" != m ? h = false : xe.test(g) ? h = h == g : (g = g.split(".").join("\\."), h = new RegExp("^(.+\\." + g + "|" + g + ")$", "i").test(h));
          if (h) {
            c = true;
            break a;
          }
  ...
  function zk() {
    ...
    this.a = Bk() || import_app.default.INTERNAL.node.localStorage;
  ...
  function Ak() {
    var a = "Node" == Fe();
    a = Bk() || a && import_app.default.INTERNAL.node && import_app.default.INTERNAL.node.localStorage;
    if (!a)
      return false;
    try {
  ...
  function Dk() {
    ...
    this.a = Fk() || import_app.default.INTERNAL.node.sessionStorage;
  ...
  function Ek() {
    var a = "Node" == Fe();
    a = Fk() || a && import_app.default.INTERNAL.node && import_app.default.INTERNAL.node.sessionStorage;
    if (!a)
      return false;
    try {
      return a.setItem("__sak", "1"), a.removeItem("__sak"), true;
  ...
  function Fl(a, b, c, d, e) {
    var f = import_app.default.SDK_VERSION || null;
  ...
  Cl.prototype.h = function(a, b) {
    if (a) {
      ...
      this.i = !(!e && !f);
      "unknown" != c || e || f ? a.a ? (Tl(this, true, null, a.a), D()) : b.Fa(c, d) ? Ul(this, a, b) : E(new t("invalid-auth-event")) : (Tl(this, false, null, null), D());
    } else
  ...
  function Dm(a, b, c) {
    ...
    var d = import_app.default.SDK_VERSION ? Je(import_app.default.SDK_VERSION) : null;
  ...
  function Hm(a, b) {
    a.X = b;
    Ni(a.a, import_app.default.SDK_VERSION ? Je(import_app.default.SDK_VERSION, a.X) : null);
  }
  ...
  k.Eb = function(a, b) {
    return "linkViaPopup" == a && (this.h || null) == b && this.g || "reauthViaPopup" == a && (this.h || null) == b && this.g || "linkViaRedirect" == a && (this.ga || null) == b || "reauthViaRedirect" == a && (this.ga || null) == b ? true : false;
  };
  ...
  function dn(a, b, c, d, e) {
    ...
    (!Oe() || De()) && a.o && c.isOAuthProvider && (h = ak(a.o, a.l, a.m, b, c, null, g, import_app.default.SDK_VERSION || null, null, null, a.tenantId));
  ...
  function zn(a) {
    ...
    if (S(this).options && S(this).options.apiKey)
      a = import_app.default.SDK_VERSION ? Je(import_app.default.SDK_VERSION) : null, this.a = new Ei(S(this).options && S(this).options.apiKey, Aa(Ba), a);
    else
      throw new t("invalid-api-key");
    this.R = [];
    this.u = [];
    this.P = [];
    this.ac = import_app.default.INTERNAL.createSubscribe(q(this.yc, this));
    this.X = void 0;
    this.bc = import_app.default.INTERNAL.createSubscribe(q(this.zc, this));
    An(this, null);
  ...
  k.Fc = function(a) {
    this.N.push(a);
    Ni(this.a, import_app.default.SDK_VERSION ? Je(import_app.default.SDK_VERSION, this.N) : null);
  ...
  k.Wc = function(a) {
    ...
    (!Oe() || De()) && S(this).options.authDomain && a.isOAuthProvider && (e = ak(S(this).options.authDomain, S(this).options.apiKey, S(this).name, "signInViaPopup", a, null, d, import_app.default.SDK_VERSION || null, null, null, this.S(), this.f));
  ...
  function oo(a, b, c) {
    ...
    f = import_app.default.SDK_VERSION ? Je(import_app.default.SDK_VERSION, f) : null;
  ...
  Y(zn.prototype, {
    ...
    cd: { name: "updateCurrentUser", j: [X(/* @__PURE__ */ function(a) {
  ...
  Y(hh.prototype, { eb: { name: "verifyPhoneNumber", j: [X(V(), /* @__PURE__ */ function(a, b) {
    return { name: a || "phoneInfoOptions", J: "valid phone info options", optional: !!b, K: function(c) {
      return c ? c.session && c.phoneNumber ? Ao(c.session, vg) && "string" === typeof c.phoneNumber : c.session && c.multiFactorHint ? Ao(c.session, wg) && Bo(c.multiFactorHint) : c.session && c.multiFactorUid ? Ao(c.session, wg) && "string" === typeof c.multiFactorUid : c.phoneNumber ? "string" === typeof c.phoneNumber : false : false;
    } };
  }(), "phoneInfoOptions"), Co()] } });
  ...
  (function() {
    if ("undefined" !== typeof import_app.default && import_app.default.INTERNAL && import_app.default.INTERNAL.registerComponent) {
      ...
      import_app.default.registerVersion("@firebase/auth", "0.15.0");
      import_app.default.INTERNAL.extendNamespace({ User: Dm });
    } else
