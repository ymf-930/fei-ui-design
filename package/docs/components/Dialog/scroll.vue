    ...
    <vs-dialog scroll overflow-hidden not-close auto-width v-model="active">
      ...
      <div class="con-content-scroll">
        ...
        <p>
          ...
          <br>
          <br>
          - F-UI-DESIGN uses native css variables for better customization and production changes such as changing to dark theme or changing the main color of the entire application with few javascript lines
          <br>
          <br>

          - F-UI-DESIGN is a frame designed to have a great visual impact and that is always in trend with respect to design.
          <br>
          <br>
