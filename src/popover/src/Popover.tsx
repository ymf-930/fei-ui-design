...
import { FPopper, renderArrow, renderPopper, renderTrigger } from '../../_internal/popper'
...
export default defineComponent({
  ...
  setup(props, ctx) {
    if (process.env.NODE_ENV !== 'production' && props.visible && !ctx.slots.reference) {
      console.warn('[FPopover] You cannot init popover without given reference')
    }
  ...
  render() {
    ...
    const kls = [this.content ? 'fei-popover--plain' : '', 'fei-popover', popperClass].join(' ')
